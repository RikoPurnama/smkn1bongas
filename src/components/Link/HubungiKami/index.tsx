...
const LinkHubungiKami = () => {
  return (
    <div className="w-52 hidden group-hover/hubungi:block hover:block lg:bg-nav py-4 px-4 lg:px-10 lg:absolute top-[100%] rounded-b-lg border-t-2 border-primary">
